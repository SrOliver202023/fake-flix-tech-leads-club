...
export abstract class DefaultTypeOrmRepository<T extends ObjectLiteral> {
  ...
  constructor(
    ...
    /**
     * Note that we don't extends the Repository class from TypeORM, but we use it as a property.
  ...
  /**
   * These are test only methods that should not be used in real environments
   */
